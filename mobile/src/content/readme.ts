/**
 * The project README, bundled as a string for the About screen. The web app
 * fetched /README.md over HTTP (no equivalent static path on native), so the
 * content is shipped with the app instead (plan §2.9 / §7-About).
 */
export const README_MARKDOWN = `# A Sudoku Puzzle Server with a Vue Frontend
